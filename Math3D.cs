    ...
    class Math3D
    {
        ...
        public class Cube
        {
            ...
            public float RotateX
            {
                ...
                set
                {
                    //Rotacion desde las diferencias
            ...
            //Calcula los puntos en 2D
            private void Update2DPoints(Point drawOrigin)
            {
                //Actualiza los puntos 2D en todos.
            ...
            private void RotateCubeX(float deltaX)
            {
                for (int i = 0; i < faces.Length; i++)
                {
                    //------Rotacion en los puntos
                    Vector3D point0 = new Vector3D(0, 0, 0);
                    faces[i].Corners3D = Math3D.Translate(faces[i].Corners3D, cubeOrigin, point0); //Movimiento de la esquina al origen;
                    faces[i].Corners3D = Math3D.RotateX(faces[i].Corners3D, deltaX);
                    faces[i].Corners3D = Math3D.Translate(faces[i].Corners3D, point0, cubeOrigin); //Movimiento anterior;

                    //-------Rotacion en el Centro
